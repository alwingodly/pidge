...
const patchSchema = z.object({
  ...
  slotIntervalMins:    z.number().int().min(5).max(240).optional(),
  lunchBreakStart:     z.string().regex(timeRegex).or(z.literal("")).optional(),
  lunchBreakEnd:       z.string().regex(timeRegex).or(z.literal("")).optional(),
  reviewLink:           z.string().url("Must be a valid URL").or(z.literal("")).optional(),
  reviewEmailEnabled:   z.boolean().optional(),
  patientCancelEnabled: z.boolean().optional(),
  ...
  cancellationEmailEnabled: z.boolean().optional(),
